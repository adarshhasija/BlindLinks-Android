...
/**
 * An activity representing a list of Records. This activity has different
 ...
 */
public class RecordListActivity extends FragmentActivity implements
		RecordListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.record_detail_container) != null) {
			...
			((RecordListFragment) getSupportFragmentManager().findFragmentById(
					R.id.record_list)).setActivateOnItemClick(true);
		}
	...
	public void onItemSelected(int requestCode, ParseProxyObject data) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.record_detail_container, fragment).commit();
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		...
		((RecordListFragment) getSupportFragmentManager().findFragmentById(
				R.id.record_list)).onActivityResult(arg0, arg1, arg2);
	}
